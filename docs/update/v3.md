...
* fix: 修复反向 WS 鉴权反转、BotMap 误注销、排程串扰等一批低风险 bug（v3.2.10） by [@crazywhalecc](https://github.com/crazywhalecc) in [PR#386](https://github.com/zhamao-robot/zhamao-framework/pull/386)
